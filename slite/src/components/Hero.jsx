    ...
    <div className=" bg-[#F9EFE4] py-10 text-center h-[160vh]">
      <h1 className=" relative md:text-6xl text-3xl mt-12">
        ...
        <img
          src={under}
          alt=""
          className=" absolute md:left-[29rem] top-[2rem] md:top-[3.5rem] left-[100px] md:w-[200px] w-[100px] animate-bounce"
        />
      </h1>
      ...
      <section className=" flex flex-col justify-center items-center relative md:w-[50rem] px-5 w-[80vw] mx-auto md:px-[10rem] ">
        <span className=" text-gray-700 text-sm font-semibold  text-center">
          8:45 aM - PDT
        </span>
        <div className=" card bg-white rounded-md h-[7rem] md:w-[26rem]  w-[85vw] shadow-md absolute top-11"></div>
        <div className=" bg-white rounded-md h-[6.5rem] md:w-[28rem] w-[90vw] absolute top-11 shadow-md  py-5  flex justify-start md:pl-10 pl-4  items-center  ">
        ...
        <div className=" bg-white rounded-md h-[6rem] md:w-[30rem] w-[95vw] absolute top-11 shadow-md animate-bounce py-5  flex justify-start md:pl-10 pl-4 items-center ">
          <img src={pile} alt="" className=" w-[4.5rem]" />{" "}
          <section className=" pl-5 ">
            <p className=" font-semibold">Georges made some changes</p>
            <p>The abnormal guide to remote</p>
